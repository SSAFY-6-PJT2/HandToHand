<template>
  <div>
    <!-- 기부 Form -->
    <card class="mr-5" color="black" :width="24" :height="24">
      ...
      <div class="card-footer text-center">
        <n-button v-if="isWalletConnected" type="success" round size="lg">송금하기</n-button>
      ...
      if (this.isMetaMaskInstalled) {
        ethRequest("eth_requestAccounts")
          .then((res) => {
            ...
            ethRequest("eth_getBalance", [this.userAddress, "latest"]).then((res) => {
              console.log(res);
