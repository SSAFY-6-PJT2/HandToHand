...
| :----: | :------------------------: | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 김응철 |          Backend           | - DB 설계 <br /> - JPA 구조 설계<br />- 판매 정보 등록, 조회, 취소, 완료 API 구현<br /> - 구매자 정보 업데이트 API 구현                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| 이상백 | AI & Blockchain & Frontend | 1. [블록체인] 스마트 컨트랙트 설계 <br /> A. HandToHand 개별 토큰 개발 (HTH, ERC-20)<br /> 1) `Ownable` 도입으로 토큰의 발행 주체 단일화<br /> 2) Gas 비용 절감을 위한 조회용 `view` 함수 조회<br /> 3) 송금에 중간 개입자 개입을 위한 `approve` 함수 구현<br /> B. NFT 개발 (ERC-721)<br /> 1) 토큰 발행 주체의 단일화<br /> 2) 조회용 `view` 함수 구현 (NFT 정보 조회시 Gas 비용 절감)<br /> 3) NFT 이전에 중간 개입자 개입을 위한 `approve` 함수 구현<br /> C. 서비스 개별 토큰(HTH)을 이용한 NFT 거래 플랫폼 개발<br /> 1) `SaleFactory` 컨트랙트 도입 및 `Sale` 주체 단일화<br /> 2) NFT 입찰 및 판매에 생성되는 Sale 컨트랙트 구현<br /> 3) 각 동작별 분기처리를 위한 `Modifier` 함수 구현<br /> 4) 입찰, 판매 동작시 log 기록을 위한 `Event` 함수 구현<br /> 2. [인공지능] Deep Learning 모델 설계<br /> A. 목표 결과물 설정<br /> 1) 우크라이나의 풍경화, 도시화 학습 모델 설정<br /> 2) style 변수를 입힌 GAN 모델 모색, StyleGAN3 모델 설정<br /> B. Training 데이터 수집<br /> 1) 우크라이나 자연 및 도시 풍경 Crawling 이미지 (약 3,000 개)<br /> 2) WikiArt cityscape image (약 5,000 개)<br /> 3) WikiArt landscape image (약 5,000 개)<br /> C. GAN 모델 학습<br /> 1) 1차 학습 : `gamma=8.2`, 약 4-5 일 학습 진행<br /> 2) 2차 학습 : `gamma=6.6`, 약 1-2 일 학습 진행<br /> D. 결과물 도출 및 검증<br /> 1) 학습 모델 활용 이미지 생성 (약 2,600개)<br /> 2) `FID` 값 10~11 에 수렴<br /> 3) `kimg` 값 4500~5000 도달<br /> 3. [프론트] NFT 거래 페이지 구현<br /> A. Front <=> SSAFY 네트워크 (블록체인) 연결<br /> 1) 블록체인 연결에 Web3 라이브러리 도입<br /> 2) Front 에서 `approve` 권한 구현<br /> B. NFT 판매, 입찰 동작 구현<br /> 1) 스마트 컨트랙트 함수 기반의 판매, 입찰 동작 구현<br /> C. NFT 거래 내역 기록<br /> 1) 스마트 컨트랙트 동작 후, 서비스 개별 DB 에 기록 |
