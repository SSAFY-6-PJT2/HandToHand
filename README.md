...
- |  이름  |            역할            | <div align="center">개발 내용</div>                          |
  ...
  | 정은이 |       Backend & 팀장       | - Test Server 구현<br />- DB 설계<br />- JPA 구조 설계<br />\- 기부 API<br/>  \- 기부 요청 API<br/>  \- 기부 상태 업데이트 API<br />  \- 기부 조회 API<br />\- 작품 API<br/>  \- 파일 업로드 API<br/>  \- 작품 지급 API<br/>  \- 작품 정보 업데이트 API<br />  \- 작품 상세 조회 API<br />\- 회원API<br/>  \- 지갑 연동 API<br/>  \- 닉네임 변경 API<br />  \- 작품 상세 조회 API<br />- Spring Boot S3 연결 |
